...
class MmenuBackend extends MmHtml {
	...
	//	The text explaining to get a license
...
<pre>Cart, Language</pre>',
	...
	protected function opt_menu_sizes( $mm_menu )
	{
		...
		$this->echo_form_table_row(
			__( 'Item size', 'mmenu' ) . '<br />
				<small>' . __( 'Specify the size for all items in the menu', 'mmenu' ) . '</small>',
	...
	*/
	public function update_check()
	{
		...
		$version 	= isset( $mm_setup[ 'plugn_version' ] ) ? $mm_setup[ 'plugin_version' ] : '0';
